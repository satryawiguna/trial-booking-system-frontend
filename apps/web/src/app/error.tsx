...
// handling (all pages in this app fetch via `@shared/hooks`, which already
// surface API errors as in-page `ErrorMessage` state) — a safety net, not
// the primary error UX.

...
**Verified against:** [api-design.md](https://github.com/satryawiguna/trial-booking-system-context/blob/master/architecture/api-design.md) (branch `master`, via MCP Server GitHub)
